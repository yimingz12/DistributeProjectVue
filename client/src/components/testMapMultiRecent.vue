...
<template>
    ...
    <div class="display-3" style ="color:green">Multiple Recent Time Analysis</div>
    <v-row>
      <v-col>
...
export default {
   ...
   //response.data.data.rows
    this.ACTUser = this.info.ACT.multiple_recent_time
    this.NSWUser = this.info.NSW.multiple_recent_time
    this.NTUser = this.info.NT.multiple_recent_time
    this.QLDUser = this.info.QLD.multiple_recent_time
    this.SAUser = this.info.SA.multiple_recent_time
    this.TASUser = this.info.TAS.multiple_recent_time
    this.VICUser = this.info.VIC.multiple_recent_time
    this.WAUser = this.info.WA.multiple_recent_time
