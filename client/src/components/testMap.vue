...
<template>
    ...
    <div class="display-3" style ="color:green">Australian User Analysis</div>
    <v-row>
      <v-col>
...
export default {
   ...
   //response.data.data.rows
    this.ACTUser = this.info.ACT.user_num
    this.NSWUser = this.info.NSW.user_num
    this.NTUser = this.info.NT.user_num
    this.QLDUser = this.info.QLD.user_num
    this.SAUser = this.info.SA.user_num
    this.TASUser = this.info.TAS.user_num
    this.VICUser = this.info.VIC.user_num
    this.WAUser = this.info.WA.user_num
