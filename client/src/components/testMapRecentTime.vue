...
export default {
   ...
   //response.data.data.rows
    this.ACTUser = this.info.ACT.recent_time
    this.NSWUser = this.info.NSW.recent_time
    this.NTUser = this.info.NT.recent_time
    this.QLDUser = this.info.QLD.recent_time
    this.SAUser = this.info.SA.recent_time
    this.TASUser = this.info.TAS.recent_time
    this.VICUser = this.info.VIC.recent_time
    this.WAUser = this.info.WA.recent_time
