...
<template>
    ...
    <div class="display-3" style ="color:green">Total Played Time Analysis</div>
    <v-row>
      <v-col>
...
export default {
   ...
   //response.data.data.rows
    this.ACTUser = this.info.ACT.total_time
    this.NSWUser = this.info.NSW.total_time
    this.NTUser = this.info.NT.total_time
    this.QLDUser = this.info.QLD.total_time
    this.SAUser = this.info.SA.total_time
    this.TASUser = this.info.TAS.total_time
    this.VICUser = this.info.VIC.total_time
    this.WAUser = this.info.WA.total_time
